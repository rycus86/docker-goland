...
ARG go_source=https://dl.google.com/go/go1.12.6.linux-amd64.tar.gz
...
ARG goland_source=https://download.jetbrains.com/go/goland-192.5118.39.tar.gz
ARG goland_local_dir=.GoLand2019.2
