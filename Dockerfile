...
ARG go_source=https://dl.google.com/go/go1.13.linux-amd64.tar.gz
...
ARG goland_source=https://download.jetbrains.com/go/goland-193.2956.43.tar.gz
ARG goland_local_dir=.GoLand2019.3
