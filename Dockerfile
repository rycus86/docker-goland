...
ARG goland_source=https://download.jetbrains.com/go/goland-182.3569.26.tar.gz
...
RUN echo 'export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/go/bin' >> ~/.bashrc
